    ...
    return (
        <section className="embla">
            <div className={`embla__viewport relative ${props.radius} ${props.height}`} ref={emblaRef}>
                ...
                <div className='absolute top-0 left-0 flex h-full items-center justify-center px-0 md:px-4'>
                    <PrevButton onClick={onPrevButtonClick} disabled={prevBtnDisabled} />
                </div>
                <div className='absolute top-0 right-0 flex h-full items-center justify-center px-0 md:px-4'>
