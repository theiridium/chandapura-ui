        ...
        <>
            ...
            <div className='col-span-full lg:col-span-6 mt-3 lg:my-8'>
                ...
                <div className='grid grid-cols-1 gap-10 mx-2'>
                    ...
                    <div className='listing-card border rounded-lg px-7 py-6 scroll-mt-36'>
                        {isGalleryImagesLoaded ? <MultiImage key={keyGa} imageParams={imageParamsGallery} setIsImagesInGallery={setIsImagesInGallery} uploadSuccess={reloadGalleryComp} setEditMode={setEditMode} numberOfImgs={10} /> :
