            ...
            <div className="job-card p-5 w-80 md:w-auto">
                <div className='flex flex-row gap-5 items-center'>
                    ...
                    <div className='basis-4/5'>
                        <div className='text-lg font-semibold text-slate-700'>{item.job_title}</div>
                ...
                <div className="text-sm mb-5 flex items-center"><Banknote size={15} className='mr-2' /><IndianRupee size={15} /> {item.salary_range_min} - <IndianRupee size={15} /> {item.salary_range_max} monthly</div>
                <div className='flex'>
                    <div className='job-card-tags'>
                        <div>{item.job_type}</div>
                        <div>{item.job_location}</div>
