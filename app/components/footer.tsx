    ...
    <footer className="">
      <div className="max-w-screen-xl mx-auto px-3 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="/" className="flex items-center">
              <img src="/images/logo_ch.png" className="h-40" alt="FlowBite Logo" />
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center">© 2024 <a href="https://flowbite.com/" className="hover:underline">Chandapura.com</a>. All Rights Reserved.
          </span>
