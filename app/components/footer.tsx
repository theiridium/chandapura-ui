    ...
    <footer className="">
      <div className="border border-gray-300 border-t-1">
        <div className="max-w-screen-xl mx-auto px-3 py-6 lg:py-8">
          <h2 className="font-medium">Chandapura.com – Your All-in-One Platform for Local Businesses, Jobs, Real Estate, and Buy/Sell in Chandapura and Nearby Areas</h2>
          <div className="text-sm mt-4 *:mb-3 text-gray-500">
            ...
            <p>Chandapura.com offers comprehensive business details, contact information, and a seamless experience through our website. Our listing service allows businesses to showcase their offerings, while users can explore job openings, real estate listings, exclusive deals, and instant quotes for the best value.</p>
