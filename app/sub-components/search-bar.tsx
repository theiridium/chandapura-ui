...
const SearchBar = ({ productType }: any) => {
  ...
  return (
    <form className={`search-container ${isFocused && 'ring-1'}`} onSubmit={onSearch}>
      ...
      <button className="search-container-btn disabled:opacity-50 hover:bg-color1d/80 disabled:hover:bg-color1d disabled:hover:opacity-50 disabled:cursor-not-allowed" type="submit" disabled={text == "" || payload == undefined}>
