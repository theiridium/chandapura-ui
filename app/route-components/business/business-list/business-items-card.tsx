                ...
                <div className="flex-none md:flex p-5 lg:p-7 gap-x-5 lg:gap-x-7">
                    ...
                    <div className="w-full flex flex-col">
                        ...
                        <div className="w-full flex justify-between lg:justify-normal gap-x-6">
                            <button className="border-2 border-color1d bg-color1d text-white px-5 py-1 rounded-full h-fit text-center flex items-center gap-x-2 text-sm"><Phone size={16} fill='#fff' stroke='none' />+91 {data.contact_number}</button>
                        </div>
                    </div>
                </div>
            </div>
