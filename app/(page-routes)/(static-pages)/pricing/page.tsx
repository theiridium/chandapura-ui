...
const Page = () => {
    ...
    return (
        <div className='max-w-screen-xl min-h-screen mx-auto px-3 my-16'>
            <div className='text-center mb-16'>
                <h1 className="text-4xl font-semibold">Pricing plans</h1>
                <p className='my-5 text-xl font-light'>Simple & Transparent Pricing for all the business.</p>
            </div>

            {/* Advertisemnt Listing Pricing */}
            <div className='grid grid-cols-1 md:grid-cols-3 bg-color1d/10 rounded-xl *:border *:border-transparent * *:rounded-xl gap-8 p-8 content-center mb-20'>
                <div className='p-5 text-2xl font-medium place-self-center'>Advertisement Listing</div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-3 bg-color1d/10 rounded-xl *:border *:border-transparent * *:rounded-xl gap-8 p-8 pb-14 md:pb-8 content-center mb-20'>
