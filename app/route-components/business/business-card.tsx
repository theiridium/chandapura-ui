            ...
            <div className="business-card">
                ...
                <div className="business-card-body">
                    ...
                    <div className="flex items-center justify-between gap-x-3 gap-y-1">
                        <a href={`tel:${item.contact.contact_number}`} className="btn-contact rounded-md lg:grow flex justify-center items-center gap-x-2 w-auto"><Phone size={16} fill='#fff' stroke='none' /><span className='hidden lg:block'>+91 {item.contact.contact_number}</span></a>
