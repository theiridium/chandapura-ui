            ...
            <div className='col-span-6 mt-3 lg:my-8'>
                ...
                <div className='grid grid-cols-1 gap-10'>
                    ...
                    <div className='flex gap-x-5 justify-between text-xl *:w-auto *:rounded-lg *:mb-5 *:py-2 *:px-5 *:block font-semibold'>
                        <button className='btn-primary' onClick={() => router.push('/business-listing/add-details')}>Previous Step</button>
                        <button className='btn-primary' onClick={() => router.push('/business-listing/payment')}>Publish</button>
                    </div>
                </div>
            </div>
